    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-10">
        ...
        <ProjectCard
          ...
          description="Tons of data about cryptocurrencies, including real-time prices, market caps, and latest news coming from API calls! Built with React, Redux and Tailwind CSS. The app is fully responsive."
          techImages={[
            "/js.png",
            "/react.png",
            "/express.png",
        ...
        <ProjectCard
          ...
          techImages={["/js.png", "/next.png", "/tailwind.png", "/framer.png"]}
        />
      </div>
    </div>
  );
